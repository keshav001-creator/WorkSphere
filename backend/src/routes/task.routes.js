...
router.get("/workspaces/:workspaceId/task/:taskId",authUser,rbac(["Owner","Admin"]),controller.getTask)

router.get("/workspaces/:workspaceId/tasks",authUser,rbac(["Owner","Admin"]),controller.fetchTasks)
